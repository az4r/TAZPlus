...
(defun c:taz_s_create_drawings_execution_design ()
  ...
  ;; Funkcja taz_s_create_drawings_execution_design_organize zostala
  ;; wydzielona do osobnego pliku:
  ;;   taz_s_create_drawings_execution_design_organize.lsp
  ;; Jesli nie zostal on jeszcze zaladowany w biezacej sesji - doladuj go.
